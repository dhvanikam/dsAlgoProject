Feature: Testing LinkedList page
  ...
  @TS_ll_02
  Scenario: User validating the home page
  ...
  @TS_ll_04
  Scenario: User validating introduction page with try editor
  ...
  @TS_ll_05
  Scenario Outline: The user validating tryEditor page with valid input
  ...
  @TS_ll_06
  Scenario Outline: The user validating tryEditor page with invalid python code
  ...
  @TS_ll_08
  Scenario: User validating creating linked list  with try editor
  ...
  @TS_ll_12
  Scenario: user validating "Types of linked list" with try editor
  ...
  @TS_ll_16
  Scenario: user validating "Implement Linked List in Python"  with try editor
  ...
  @TS_ll_20
  Scenario: user validating "Traversal"  with try editor
  ...
  @TS_ll_24
  Scenario: user validating "Insertion"  with try editor
