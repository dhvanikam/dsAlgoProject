...
Feature: Testing LinkedList page
  ...
  @TS_ll_04
  Scenario: User navigated to tryEditor page with Run button
  ...
  @TS_ll_05
  Scenario Outline: The user run the code in tryEditor with valid input
  ...
  @TS_ll_06
  Scenario Outline: The user getting error message with invalid python code
    Given The user is in a try here page having  tryEditor with a Run button to test
